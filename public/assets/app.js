...
function setView(v,el){
  ...
  if(isPw){
    ...
    document.getElementById('tbTitle').textContent=isInv?'Meu Inventário':'Inventário da Org';
    document.getElementById('pgTitle').textContent=isInv?'Meu Inventário':'Inventário da Org';
